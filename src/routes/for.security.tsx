  ...
  return (
    <AudienceLayout>
      ...
      <Pillars
        ...
        items={[
          { n: "01", title: "High-Trust Digital Presence", copy: "Win More Premium Commercial Contracts. Your website is your digital storefront. We build highly professional, secure, and modern websites designed to pass rigorous corporate procurement standards and position your firm as an industry leader." },
